...
#define nrn_init _nrn_init__NMDA_Mg
#define _nrn_initial _nrn_initial__NMDA_Mg
#define nrn_cur _nrn_cur__NMDA_Mg
#define _nrn_current _nrn_current__NMDA_Mg
#define nrn_jacob _nrn_jacob__NMDA_Mg
#define nrn_state _nrn_state__NMDA_Mg
#define _net_receive _net_receive__NMDA_Mg 
#define state state__NMDA_Mg 
...
#define mgblock mgblock_NMDA_Mg
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NMDA_Mg /Users/hillary/dev/lbl/l5pc_model/mechanisms/NMDA_Mg.mod\n");
...
double mgblock ( _threadargsprotocomma_ double _lv ) {
   double _lmgblock;
 _lmgblock = 1.0 / ( 1.0 + ( mg / 3.57 ) * exp ( - 0.062 * _lv ) ) ;
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   g = factor * ( B - A ) * mgblock ( _threadargscomma_ v ) ;
   i = g * ( v - e ) ;
   }
 _current += i;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/hillary/dev/lbl/l5pc_model/mechanisms/NMDA_Mg.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
