...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 NaTa_t /Users/hillary/dev/lbl/l5pc_model/mechanisms/NaTa_t.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/hillary/dev/lbl/l5pc_model/mechanisms/NaTa_t.mod";
static const char* nmodl_file_text = 
